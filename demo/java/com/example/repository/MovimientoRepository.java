...
public interface MovimientoRepository extends JpaRepository<Movimiento, Integer>{
	...
	@Query("SELECT p.nombre as nombre, SUM(m.cantidad) as suma ,p.precio as precio, (SUM(m.cantidad) * p.precio) as cantidad FROM Movimiento m JOIN m.producto p  GROUP BY p.nombre ")	
